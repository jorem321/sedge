...
The Mainnet launch is expected soon. You can check your eligibility on the Early Adoption program for Mainnet [here](https://lidofinance.github.io/csm-ea-checker/).
